...
[![Release](https://img.shields.io/badge/Release-v1.7.0-blue.svg)](https://github.com/knmt1219/codex-security-linter/releases)
...
jobs:
  audit:
    ...
    steps:
      ...
      - uses: knmt1219/codex-security-linter@v1.7.0
        with:
